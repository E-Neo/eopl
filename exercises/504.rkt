...
;; % The value of the following program is 0
;; let3 x = 2
;;      y = 3
;;      z = 5
;; in let f = proc (x) proc (y) -(x, y)
;;    in letrec g(x) = proc (y) -(x, -(0, y))
;;       in ((f z) ((g x) y))
  ...
  (lambda (exp env cont)
    (cases expression exp
           ...
           (let3-exp (var1 exp1 var2 exp2 var3 exp3 body)
                     (value-of/k exp1 env
                                 (let3-exp1-cont
                                  var1 var2 exp2 var3 exp3 body env cont))))))
...
(define apply-cont
  (lambda (cont val)
    (cases continuation cont
           ...
           (let3-exp1-cont
            (var1 var2 exp2 var3 exp3 body saved-env saved-cont)
            (value-of/k exp2 saved-env
                        (let3-exp2-cont
                         var1 val var2 var3 exp3
                         body saved-env saved-cont)))
           (let3-exp2-cont
            (var1 val1 var2 var3 exp3 body saved-env saved-cont)
            (value-of/k exp3 saved-env
                        (let3-exp3-cont
                         var1 val1 var2 val var3 body saved-env saved-cont)))
           (let3-exp3-cont
            (var1 val1 var2 val2 var3 body saved-env saved-cont)
            (value-of/k body
                        (extend-env var3 val
